...
app.get('/latest-order-id/dessert', async (req, res) => {
  try {
    ...
    if (latestOrderID) {
      ...
      res.status(404).json({ message: 'No order data available in Dessert tab.' });
    }
  } catch (error) {
    res.status(500).json({ message: 'Error fetching OrderID from Dessert tab' });
  }
});
...
app.post('/add-order/dessert', async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({ message: 'Order added successfully to Dessert tab' });
  } catch (error) {
...
app.get('/latest-detail-id/soda', async (req, res) => {
  try {
    ...
    if (latestDetailID) {
      ...
      res.status(404).json({ message: 'No detail data available in OrderDetailSoda tab.' });
    }
  } catch (error) {
    res.status(500).json({ message: 'Error fetching DetailID from OrderDetailSoda tab' });
  }
});
...
app.get('/latest-detail-id/tea', async (req, res) => {
  try {
    ...
    if (latestDetailID) {
      ...
      res.status(404).json({ message: 'No detail data available in OrderDetailTea tab.' });
    }
  } catch (error) {
    res.status(500).json({ message: 'Error fetching DetailID from OrderDetailTea tab' });
  }
});
...
app.get('/latest-detail-id/dessert', async (req, res) => {
  try {
    ...
    if (latestDetailID) {
      ...
      res.status(404).json({ message: 'No detail data available in OrderDetailDessert tab.' });
    }
  } catch (error) {
    res.status(500).json({ message: 'Error fetching DetailID from OrderDetailDessert tab' });
  }
});
...
app.post('/add-order-detail/soda', async (req, res) => {
  ...
  if (!DetailId || !OrderId || !ProductName || !Quantity || !PricePerCup) {
    return res.status(400).json({ message: 'Missing required order detail data' });
  }
  ...
  try {
    ...
    res.status(201).json({ message: 'Order detail added successfully to Soda tab' });
  } catch (error) {
...
app.post('/add-order-detail/tea', async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({ message: 'Order detail added successfully to Tea tab' });
  } catch (error) {
...
app.post('/add-order-detail/dessert', async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({ message: 'Order detail added successfully to Dessert tab' });
  } catch (error) {
    res.status(500).json({ message: 'Error adding order detail to Dessert tab' });
  }
});
