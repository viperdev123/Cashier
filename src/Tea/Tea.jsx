...
import Matcha_Cocoa from "../assets/MatchaCocoa.png"
import Matcha_Latte from "../assets/Matchalatte.png"
import Thai_Tea from "../assets/thaitea.png"
import Thai_Cocoa from "../assets/thaicocoa.png"
import Dark_Cocoa from "../assets/DarkCocoa.png" 

// Mapping of soda names to their image URLs
const TeaImages = {
  "banoffee": banoffee,
  "chocolate dubai": dubai,
  "มรกตต้องมนต์ในเงาดำ": Matcha_Cocoa,
  "มัจฉะอเวจี": Matcha_Latte,
  "สบงทรงพลัง": Thai_Tea,
  "เงาทรายแดงในคืนมืด": Thai_Cocoa,
  "ดาร์คโกโก้รัตติกาล": Dark_Cocoa,
};
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      const ordersResponse = await fetch(
        "https://sheets.googleapis.com/v4/spreadsheets/1lxwIXRhZGW7-OJ7b5naD3jV83FgEoaNfNuYtFhgsFT0/values/Tea!A1:Z1000?key=AIzaSyCxoYDs3MtxkZfqFgwPZLS5qn7Z0NQK57Q"
      );
    ...
    const fetchOrderDetails = async () => {
      const detailsResponse = await fetch(
        "https://sheets.googleapis.com/v4/spreadsheets/12Aeg4-g0Aw3eXLSQAxKl4kvedwqlO11LrPx1cykc4w4/values/OrderDetailTea!A1:Z1000?key=AIzaSyCxoYDs3MtxkZfqFgwPZLS5qn7Z0NQK57Q"
      );
